// components/TalentsAppActivity.tsx
...
const TalentsAppActivity: React.FC = () => {
  return (
    <div className="p-5 rounded-lg shadow-lg w-full h-96">
      <h2 className="text-black dark:text-white text-2xl mb-4">In App Activity (Talents)</h2>
      <div className="flex p-4 justify-between">
        <div className="w-[180px] h-[180px]">
          <Doughnut data={data} options={options} />
        </div>
        <div className="w-1/3 text-black dark:text-white text-lg flex flex-col justify-center space-y-2">
...
export default TalentsAppActivity;
