...
export const PublicCta: React.FC<{
    ...
    return (
        <div className="fixed w-[80vw] ml-[10vw] mx-auto mt-8 shadow-xl rounded-full bg-white h-16 flex justify-between items-center px-4 md:px-16">
            <span className="text-lg md:text-xl font-medium">
                {type === 'talent' ? `Looking to hire ` : `Looking to work at `}
