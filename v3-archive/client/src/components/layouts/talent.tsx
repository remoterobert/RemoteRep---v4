                    ...
                    <div className="inline-flex gap-x-6">
                        <Menu as="div" className="relative">
                            ...
                            <Transition
                                ...
                                leaveTo="transform opacity-0 scale-95"
                            >
                                <Menu.Items className="absolute right-0 h-72 z-10 mt-5 w-72 origin-top-right rounded-md bg-gray-900 py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                    <div className="px-8 py-2 border-b-2 w-full">
                                        <span className="text-md font-semibold text-white">
                                            Notifications
                                        </span>
                        ...
                        <Menu as="div" className="relative">
                            <Menu.Button className="-m-1.5 flex items-center p-1.5">
                                ...
                                {user?.talentData?.profile?.photoUrl ? (
                                    ...
                                    <UserCircleIcon className="h-8 w-8 rounded-full bg-black" />
                                )}
                            </Menu.Button>
                            <Transition
                                as={Fragment}
