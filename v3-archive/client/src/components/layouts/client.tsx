...
export default function ClientLayout({
    ...
    useEffect(() => {
        (async () => {
            const notificationsRequest = await apiRequest(
                'GET',
                '/notifications'
            );
            ...
            if (notificationsRequest.status === 200) {
                const newNotifications = (
                    notificationsRequest.data as any[]
                ).filter(
                    (n) =>
                        !n.seen && !notifications.some((nn) => nn.id === n.id)
                );
                ...
                newNotifications.forEach((n) =>
                    addNotification({
                        ...
                        text: 'Check your notifications for further details.',
                    })
                );

                setNotifications(notificationsRequest.data as any[]);
            }
        })();

        setTimeout(() => setUpdateNotifications(updateNotifications + 1), 5000);
    }, [updateNotifications]);
                        ...
                        <nav className="flex flex-1 flex-col">
                            ...
                            >
                                ...
                                {/* <li className="-mx-6 mt-auto -mb-6">
                                    <Menu as="div">
                                        <Menu.Button className="group flex items-center gap-x-4 px-7 py-4 text-sm font-semibold leading-6 text-white hover:bg-gray-800">
                                            <span className="sr-only">
                                            ...
                                            {notifications.length ? (
                                                <>
                                                    <div className="absolute mb-8 ml-5 mx-2 my-auto text-red-600 bg-red-600/10 flex-none rounded-full p-1">
                                                        <div className="h-1.5 w-1.5 rounded-full bg-current" />
                                                    </div>
                                                    <BellAlertIcon className="h-6 w-6 text-red-600" />
                                                </>
                                            ) : (
                                                <BellIcon className="h-6 w-6 text-gray-400 group-hover:text-white" />
                                            )}
                                        </Menu.Button>
                                        <Transition
                                            as={Fragment}
                                        ...
                                        >
                                            <Menu.Items className="absolute h-72 z-40 ml-20 bottom-[4.5rem] w-72 rounded-md bg-gray-900 py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                                ...
                                                <div className="overflow-y-auto scrollbar-thin">
                                                    {notifications.length ? (
                                                        ...
                                                        <Menu.Item key={'i'}>
                                                            <a
                                                                className={
                                                                    'bg-gray-900 text-gray-400 block px-3 py-1 text-sm leading-6 hover:text-white hover:bg-gray-800'
                                                                }
                                                            >
                                                                You have no new
                                                                notifications.
                                    ...
                                    <Menu as="div">
                                        <Menu.Button className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-gray-800">
                                            ...
                                            {user?.clientData?.profile
                                                ...
                                                <BuildingOffice2Icon className="h-8 w-8 rounded-full bg-gray-50" />
                                            )}
                                        </Menu.Button>
                                        <Transition
                                            as={Fragment}
                ...
                <div className="sticky top-0 z-40 flex items-center justify-between gap-x-6 bg-gray-900 px-4 py-4 shadow-sm sm:px-6 lg:hidden shadow-xl">
                    ...
                    <div className="inline-flex gap-x-6">
                        <Menu as="div" className="relative">
                            <Menu.Button className="-m-1.5 flex items-center p-2.5">
                                <span className="sr-only">
                                    Open notifications menu
                                </span>
                            ...
                            <Transition
                                ...
                                leaveTo="transform opacity-0 scale-95"
                            >
                                <Menu.Items className="absolute h-72 right-0 z-10 mt-5 w-72 origin-top-right rounded-md bg-gray-900 py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                    <div className="px-8 py-2 border-b-2 w-full">
                                        <span className="text-md font-semibold text-white">
                                            Notifications
                                        </span>
                    ...
                    <div className="inline-flex gap-x-6 top-0 z-40 flex items-center justify-end gap-x-6 px-4 py-4 shadow-sm sm:px-6">
                        <Menu as="div" className="relative">
                            <Menu.Button className="-m-1.5 flex items-center p-2.5">
                                ...
                                {notifications.length ? (
                                    <>
                                        <div className="fixed mb-8 ml-5 mx-2 my-auto text-red-600 bg-red-600/10 flex-none rounded-full p-1">
                                            <div className="h-1.5 w-1.5 rounded-full bg-current" />
                                        </div>
                                        <BellAlertIcon className="h-6 w-6 text-red-600" />
                                    </>
                                ) : (
                                    <BellIcon className="h-6 w-6 text-black dark:text-white group-hover:text-black" />
                                )}
                            </Menu.Button>
                            <Transition
                                as={Fragment}
                                ...
                                leaveTo="transform opacity-0 scale-95"
                            >
                                <Menu.Items className="fixed right-0 h-72 z-10 mt-5 w-72 origin-top-right rounded-md bg-gray-900 py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                    <div className="px-8 py-2 border-b-2 w-full">
                                        <span className="text-md font-semibold text-white">
                                            Notifications
                                        </span>
                        ...
                        <Menu as="div" className="relative">
                            <Menu.Button className="-m-1.5 flex items-center p-1.5">
                                ...
                                {user?.clientData?.profile?.photoUrl ? (
                                    ...
                                    <BuildingOffice2Icon className="h-8 w-8 rounded-full bg-white" />
                                )}
                            </Menu.Button>
                            <Transition
                                as={Fragment}
